...
// Load this file's selection again by visiting: http://mootools.net/more/17574c65e2085aa0c2aa51e7b1408304 
// Or build this file again with packager using: packager build More/Elements.From More/OverText More/Fx.SmoothScroll
/*
---
copyrights:
...
}}}return(b||new Element("div")).set("html",e).getChildren();};Class.Mutators.Binds=function(a){if(!this.prototype.initialize){this.implement("initialize",function(){});
